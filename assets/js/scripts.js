(function(){
	...
	// ****** GOOGLE MAP *******
	var map;
	var brooklyn = new google.maps.LatLng(19.17242,72.86045);
	...
	function initialize() {
		...
		var mapOptions = {
			...
			center: new google.maps.LatLng(19.17267,72.85865),
		...
		var myLatLng = new google.maps.LatLng(19.17242,72.86045);
